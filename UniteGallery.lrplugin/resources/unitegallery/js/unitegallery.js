...
function UGSoundCloudAPI(){
	...
	function putSoundActually(divID, trackID, width, height, isAutoplay){
		...
		var url = "https://w.soundcloud.com/player/?url=http://api.soundcloud.com/tracks/"+trackID;
...
function UGHtml5MediaAPI(){
	...
	function putVideoActually(divID, data, width, height, isAutoplay){
		...
		var urlFlash = "https://cdnjs.cloudflare.com/ajax/libs/mediaelement/2.18.1/flashmediaelement-cdn.swf";
		var urlSilverlight = "https://cdnjs.cloudflare.com/ajax/libs/mediaelement/2.18.1/silverlightmediaelement.xap";
...
function UGVimeoAPI(){
	...
	function putVideoActually(divID, videoID, width, height, isAutoplay){
		...
		var url = "https://player.vimeo.com/video/"+videoID+"?api=1";
